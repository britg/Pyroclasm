...
class Notification {
    ...
    static function Post(sender, name : String) { Post(sender, name, null); }
    static function Post(sender, name : String, data) {
    	NotificationCenter.DefaultCenter().PostNotification(sender, name, data);
    }
    
    static function Observe(observer, name : String) {
